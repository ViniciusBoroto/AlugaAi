    ...
    <div className={cn("flex flex-col gap-4 w-full max-w-md", className)} {...props}>
      <Card className="rounded-2xl">
        <CardContent className="pt-6">
          <div className="grid w-full grid-cols-2 mb-6 p-1 bg-muted rounded-md">
            <button 
              className={cn(
                "py-1.5 text-sm font-medium rounded-sm transition-all",
                activeTab === "renter" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground"
              )}
            ...
            <button 
              className={cn(
                "py-1.5 text-sm font-medium rounded-sm transition-all",
                activeTab === "store" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground"
              )}
            ...
            <form onSubmit={handleRenterSubmit}>
              <FieldGroup>
                <Field>
                  ...
                  <Input id="renter-name" value={name} onChange={(e) => setName(e.target.value)} required />
                </Field>
                <Field>
                  <FieldLabel htmlFor="renter-cpf">CPF</FieldLabel>
                  <Input id="renter-cpf" value={cpf} onChange={(e) => setCpf(e.target.value)} required />
                </Field>
                <Field>
                  <FieldLabel htmlFor="renter-email">E-mail</FieldLabel>
                  <Input id="renter-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
                </Field>
                <Field>
                  <FieldLabel htmlFor="renter-phone">Telefone</FieldLabel>
                  <Input id="renter-phone" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} required />
                </Field>
                <Field>
                  <FieldLabel htmlFor="renter-password">Senha</FieldLabel>
                  <Input id="renter-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                </Field>
            ...
            <form onSubmit={handleStoreSubmit}>
              <FieldGroup>
                <Field>
                  ...
                  <Input id="store-name" value={fantasyName} onChange={(e) => setFantasyName(e.target.value)} required />
                </Field>
                <Field>
                  <FieldLabel htmlFor="store-cnpj">CNPJ</FieldLabel>
                  <Input id="store-cnpj" value={cnpj} onChange={(e) => setCnpj(e.target.value)} required />
                </Field>
                <Field>
                ...
                <Field>
                  ...
                  <Input id="store-cep" value={cep} onChange={(e) => setCep(e.target.value)} required />
                </Field>
                <Field>
                ...
                <Field>
                  ...
                  <Input id="store-phone" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} required />
                </Field>
                <Field>
                  <FieldLabel htmlFor="store-password">Senha</FieldLabel>
                  <Input id="store-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                </Field>
